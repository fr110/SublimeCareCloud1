...
namespace SublimeCareCloud.Controls
{
    ...
    public class PaggingControl : Control
    {
      ...
      public  void PaggingControl_Loaded(object sender, RoutedEventArgs e)
        {
            //if (Template == null)
            //{
        ...
        public void RaisePageChanged(uint OldPage, uint NewPage)
        {
     ...
     //       ICollection<object> fetchData;//= new ICollection<object>;
            ItemsSource.Clear();
